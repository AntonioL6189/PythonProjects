...
def check_password_strength():
    ...
    if strength == 1:
        ...
        remarks = ('Now that\'s one hell of a strong password!!!'
                   'Hackers don\'t have a chanve guessing that password!')
...
if __name__ == '__main__':
    ...
    while check_pw:
        password = getpass.getpass('Enter the password: ')
        strength, remarks, lower_count, upper_count, num_count, wspace_count, special_count = check_password_strength(password)
